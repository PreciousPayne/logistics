    ...
    <main class="main">
        <nav class="top">
            <div class="top-box">
                ...
                <li  style="background-color: #1a4e8f; border-radius: .3rem .3rem 0 0;" style="color: #fff;"><a href="allshipments.php" style="color: #333;">View Shipments</a></li>
            </div>
        </nav>
        <section class="center">
            <div class="center-wrapper">
                <h3>Edit Shipment Information</h3>
                <section class="general-wrapper">
            <section class="box-section transaction-section edit-section">
            <div class="wrapper">
                <div class="boxes">
                    <form action="update.php" class="form" method="POST">
                        <label for="#">Shipper Name
                            <input type="text" name="shippername" id="shippername">
                            <input style="display: none;" type="text" name="id" id="id" value="<?php echo htmlspecialchars($update);?>"/>
                            <button name="sname">Update</button>
                        </label>
                    </form>
                    
                    <form action="update.php" class="form" method="POST">
                        <label for="#">Receiver Name
                            <input type="text" name="receiveername" id="receiveername">
                            <input style="display: none;" type="text" name="id" id="id" value="<?php echo htmlspecialchars($update);?>"/>
                            <button name="rname">Update</button>
                        </label>
                    </form>
                    ...
                    <form action="update.php" class="form" method="POST">
                        <label for="#">Address
                            ...
                            <input style="display: none;" type="text" name="id" id="id" value="<?php echo htmlspecialchars($update);?>"/>
                            <button name="radd">Update</button>
                        </label>
                    </form>
                    ...
                    <form action="update.php" class="form" method="POST">
                        <label for="#">Email
                            ...
                            <input style="display: none;" type="text" name="id" id="id" value="<?php echo htmlspecialchars($update);?>"/>
                            <button name="rem">Update</button>
                        </label>
                    </form>
                    
                    <form action="update.php" class="form" method="POST">
                        <label for="#">Type Of Shipment
                    ...
                    <form action="update.php" class="form" method="POST">
                        <label for="#">Quantity
                            ...
                            <input style="display: none;" type="text" name="id" id="id" value="<?php echo htmlspecialchars($update);?>"/>
                            <button name="qty">Update</button>
                        </label>
                    </form>
                    
                    <form action="update.php" class="form" method="POST">
                        <label for="#">Departure Time
                            <input type="time" name="depature" id="depature" >
                            <input style="display: none;" type="text" name="id" id="id" value="<?php echo htmlspecialchars($update);?>"/>
                            <button name="dpt">Update</button>
                        </label>
                    </form>
                    ...
                    <form action="update.php" class="form" method="POST">
                        <label for="#">Current Location
                            ...
                            <input style="display: none;" type="text" name="id" id="id" value="<?php echo htmlspecialchars($update);?>"/>
                            <button name="curl">Update</button>
                        </label>
                    </form>
                    ...
                    <form action="update.php" class="form" method="POST">
                     ...
                     <form action="update.php" class="form" method="POST">
                        <label for="#">Status
                            ...
                            <input style="display: none;" type="text" name="id" id="id" value="<?php echo htmlspecialchars($update);?>"/>
                            <button name="stat">Update</button>
                        </label>
                    </form>
