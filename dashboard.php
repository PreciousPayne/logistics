...
<body>
    ...
    <main class="main">
        <nav class="top">
            <div class="top-box">
                <li style="background-color: #1a4e8f; border-radius: .3rem .3rem 0 0;"><a href="dashboard.php" style="color: #fff;">Add Shipments</a></li>
                <li><a href="allshipments.php" style="color: #333;">View Shipments</a></li>
                <li><a href="logout.php" style="color: #333;">Logout</a></li>
            </div>
        </nav>
        <section class="center">
            <div class="center-wrapper">
                <h3>Add Shipment Information</h3>
                <?php if(isset($_SESSION['success'])){
                    echo '<p style="margin-bottom:1rem; font-size:1rem;color:green;">'.$_SESSION['success'].'</p>';
                    unset($_SESSION['success']);
                
                }
                else if(isset($_SESSION['error'])){
                    echo '<p style="margin-bottom:1rem; font-size:1rem;color:red;">'.$_SESSION['red'].'</p>';
                    unset($_SESSION['error']);
                }
                ;?>
                <form action="authShipment.php" class="form" method="POST">
                    <label for="#">Shipper Name
                        <input type="text" name="shippername" id="shippername" required>
                    </label>
                    
                    <label for="#">Receiver Name
                        <input type="text" name="receiveername" id="receiveername" required>
                    </label>

                    <label for="#">Phone Number
                        <input type="text" name="rphone" id="rphone" required>
                    </label>
                    ...
                    <label for="#">Packages
                        <input type="text" name="packages" id="packages" required>
                    </label>
                    ...
                    <label for="#">Departure Time
                        <input type="time" name="depature" id="depature" required>
                    </label>
                    ...
                    <label for="#">Tracking Id
                        <input type="text" name="trackid" id="trackid" required>
                    </label>
                    ...
                    <button name="addShipment">Add Shipment</button>
                </form>
            </div>
        </section>
    </main>
    ...
    <footer class="footer">
        <span>dashboard &copy; All rights reserved 2023</span>
    </footer>
</body>
</html>
<script>
